...
class ClientProcessor(Processor):
    ...
    def _execute(self):
        ...
        '''
        self.request_body = common.serialize(self.request, self.obj.api["isJsonparam"])
        ...
        common.deserialize(self.response_body, self.response, self.obj.api["isJsonparam"])
...
class ServiceProcessor(Processor):
    ...
    def enter_scope(self, scope):
        ...
        if scope == "operation":
            common.deserialize(self.request_body, self.request, False)
    ...
    def exit_scope(self, scope):
        ...
        if scope == "operation":
            self.response_body = common.serialize(self.response, False)
